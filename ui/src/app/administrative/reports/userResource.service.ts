...
export class UserResourceService {
    ...
    updateUserRoles = (id: number, role: UserRole, body: unknown) => this.http.put(this.userRolesApi(id, role), body);
    ...
    updateAgreementAccepted = (body: unknown) => this.http.put(this.updateAgreementAcceptedApi(), body);
