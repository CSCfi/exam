...
export class QuestionComponent implements CanComponentDeactivate, OnInit, OnDestroy {
    ...
    readonly questionTypes = [
        ...
        { type: 'LtiQuestion', name: 'i18n_toolbar_lti' },
    ];
    ...
    private buildUpdatedQuestion(
        ...
        const { questionBody, baseInformation, additionalInfo, essay, lti, multipleChoice, weightedMc } = formData;
        ...
        return {
            ...
            defaultEvaluationType:
                essay.defaultEvaluationType ?? lti.defaultEvaluationType ?? currentQuestion.defaultEvaluationType,
            ltiId: lti.ltiId ?? currentQuestion.ltiId,
        };
    }
