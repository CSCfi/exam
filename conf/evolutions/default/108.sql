...
ALTER TABLE exam_material
  ADD CONSTRAINT fk_exam_material_modifier FOREIGN KEY (modifier_id) REFERENCES app_user (id);
ALTER TABLE exam_material
  ADD CONSTRAINT fk_exam_material_creator FOREIGN KEY (creator_id) REFERENCES app_user (id);
...
CREATE TABLE reservation_optional_exam_section
(
  reservation_id  BIGINT NOT NULL,
  exam_section_id BIGINT NOT NULL,
  CONSTRAINT pk_reservation_optional_exam_section PRIMARY KEY (reservation_id, exam_section_id)
);
ALTER TABLE reservation_optional_exam_section
  ADD CONSTRAINT fk_reservation_optional_exam_section_exam_section FOREIGN KEY (exam_section_id) REFERENCES exam_section (id);
ALTER TABLE reservation_optional_exam_section
  ADD CONSTRAINT fk_reservation_optional_exam_section_reservation FOREIGN KEY (reservation_id) REFERENCES reservation (id);


# --- !Downs
DROP TABLE reservation_optional_exam_section;
