...
email.reservation.cancellation.subject.external=Din bokning för ett tentamensbesök {0} har avbokats
...
email.template.reservation.cancel.message.external=Din bokning för ett tentamensbesök {0} kl. {1} i {2} har avbokats av administrationen för systemet {3}.
email.template.reservation.cancel.message.external.new.booking=Om du fortfarande vill delta i tentamen, gör en ny bokning i din hemorganisations EXAM-system.
...
email.template.reservation.change.previous.time=Föregående bokning
email.template.reservation.change.current.time=Ny bokning
