(function () {
    ...
    angular.module('exam')
        .config(['$routeProvider', 'EXAM_CONF', function ($routeProvider, EXAM_CONF) {
            ...
            $routeProvider.when('/student/finishedexams', { templateUrl: tmpl + 'common/student/finished_exams.html', controller: 'ExamFeedbackController'});
            ...
            $routeProvider.when('/exams/printout/:id/:tab', { templateUrl: tmpl + 'exam/printout/printout.html', controller: 'PrintoutController', controllerAs: 'ctrl'});
