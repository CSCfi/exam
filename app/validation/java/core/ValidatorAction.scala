...
import validation.scala.core.{SanitizingException, ValidationException}

import java.util.concurrent.{CompletableFuture, CompletionStage}
import scala.jdk.CollectionConverters.*

/** Base class for sanitizers that validate and enrich HTTP requests. To be used with Java Controllers only! Scala
  * controllers should use the ScalaValidator trait instead
  */
