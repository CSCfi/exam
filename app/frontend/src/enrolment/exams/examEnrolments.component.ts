...
export class ExamEnrolmentsComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.Enrolment.getEnrolmentInfo(this.RouteParams.code, parseInt(this.RouteParams.id))
            .subscribe(exam => this.exam = exam, err => toast.error(err.data));
        this.Enrolment.listEnrolments(this.RouteParams.code, parseInt(this.RouteParams.id))
            .subscribe(exams => this.exams = exams, err => toast.error(err.data));
    }
}
