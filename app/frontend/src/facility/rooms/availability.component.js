...
angular.module('app.facility.rooms')
    .component('availability', {
        ...
        controller: ['$translate', '$routeParams', 'Room', 'Calendar', 'SettingsResource', 'InteroperabilityResource',
            function ($translate, $routeParams, Room, Calendar, SettingsRes, InteroperabilityRes) {
                ...
                const adjust = function (date, tz) {
                    let adjusted = moment.tz(date, tz);
