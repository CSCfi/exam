...
angular.module('app.exam').factory('StudentExamRes', [
    '$resource',
    function($resource) {
        return {
            ...
            teachers: $resource(
                '/app/student/inspectors/exam/:id',
                {
                    id: '@id',
                },
                {
            ...
            reservationInstructions: $resource(
