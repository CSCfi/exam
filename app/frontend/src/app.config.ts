...
export default function configs(
    ...
    // HTTP INTERCEPTOR
    $httpProvider.interceptors.push(function($q, $rootScope, $location, $translate, $window, WrongLocation) {
        'ngInject';
        return {
            response: function(response) {
                ...
                if (unknownMachine) {
                    ...
                    $location.path(enrolmentId === 'none' ? '/student/waiting-room' : '/student/waiting-room/' + id);
