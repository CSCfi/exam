...
angular.module('app.question').component('librarySearch', {
    ...
    controller: [
        ...
        function($q, Library, Session) {
            ...
            const query = function() {
                ...
                Library.search(getExamIds(), getCourseIds(), getTagIds(), getSectionIds()).then(function(questions) {
                    ...
                    function(data) {
                        ...
                        vm.exams
                            ...
                            .forEach(function(exam) {
                                examSections = examSections.concat(
                                    exam.examSections
                                        .filter(function(es) {
                                            return es.name;
                                        })
