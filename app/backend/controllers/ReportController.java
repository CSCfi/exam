...
public class ReportController extends BaseController {
  ...
  public Result getPublishedExams(Optional<String> dept, Optional<String> start, Optional<String> end) {
    ...
    for (Exam exam : exams) {
      ...
      info.participations =
        exam.getChildren().stream().filter(e -> applyExamFilter(e, start, end)).collect(Collectors.toList()).size();
      infos.add(info);
    }
  ...
  public Result getReservations(Optional<String> dept, Optional<String> start, Optional<String> end) {
    ...
    query =
      applyFilters(query, "enrolment.exam.course", "startAt", dept.orElse(null), start.orElse(null), end.orElse(null));
