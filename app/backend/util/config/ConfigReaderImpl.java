...
public class ConfigReaderImpl implements ConfigReader {
  ...
  public boolean isMaturitySupported() {
    return (
      Ebean.find(ExamExecutionType.class).where().eq("type", ExamExecutionType.Type.MATURITY.toString()).findCount() ==
      1
    );
  }
  ...
  public boolean isPrintoutSupported() {
    return (
      Ebean.find(ExamExecutionType.class).where().eq("type", ExamExecutionType.Type.PRINTOUT.toString()).findCount() ==
      1
    );
  }
